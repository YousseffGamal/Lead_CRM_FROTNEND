      ...
      <TableRow>
        {activeTab === 0 ? (
          <>
            ...
            <TableCell
              className="TableHeader"
              sx={{ color: "#667085", textAlign: "center", width: "140px" }}
            >
              Phone
            </TableCell>
            <TableCell
        ...
        ? leadsData
            ...
            .map((user, index) => (
              <TableRow key={user._id}>
                <TableCell
                  className="TableData"
                  sx={{ color: "#101828", textAlign: "center", width: "140px" }}
                >
                  {user.sellersFullName}
                </TableCell>
                <TableCell
                  sx={{ color: "#101828", textAlign: "center", width: "10px" }}
                >
                  {user.phone}
                </TableCell>
        ...
        : clientsData
            ...
            .map((user, index) => (
              <TableRow key={user.id}>
                <TableCell className="TableData" sx={{ color: "#101828" }}>
                  {user.name}
                </TableCell>
